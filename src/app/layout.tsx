...
const SITE_URL = "https://oeil-de-dieu.netlify.app";
const SITE_NAME = "ŒIL DE DIEU";
const SITE_TITLE = "ŒIL DE DIEU — Open Source Intelligence Platform | Live Flight Tracking, CCTV, OSINT Tools & More";
...
export const metadata: Metadata = {
  ...
  title: {
    default: SITE_TITLE,
    template: "%s | ŒIL DE DIEU Intelligence",
  },
  ...
  openGraph: {
    title: "ŒIL DE DIEU — The Open-Source Palantir Alternative | Live Flights, CCTV, Satellites & OSINT Tools",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "ŒIL DE DIEU — Open Source Intelligence Platform with Live Tracking & OSINT Tools",
        type: "image/png",
      },
    ],
  },
  twitter: {
    ...
    title: "🛰️ ŒIL DE DIEU — Open Source Palantir Alternative | Live Tracking + OSINT Tools",
  ...
  other: {
    ...
    "apple-mobile-web-app-title": "ŒIL DE DIEU",
...
const jsonLd = {
  ...
  "@type": "WebApplication",
  name: "ŒIL DE DIEU — OSINT Toolkit & Intelligence Platform",
  alternateName: ["ŒIL DE DIEU", "OsirisAI", "Osiris OSINT"],
  url: SITE_URL,
  description: SITE_DESCRIPTION,
